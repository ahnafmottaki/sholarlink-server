...
type IndividualAgent = z.infer<typeof individualSchema> & ModelExtraProperties;

type OrganizationAgent = z.infer<typeof organizationSchema> &
  ModelExtraProperties;
type AgentSchema = z.infer<typeof agentRegisterSchema>;
type Agent = IndividualAgent | OrganizationAgent;
export {
  agentRegisterSchema,
  AgentSchema,
  IndividualAgent,
